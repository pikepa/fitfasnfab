...
if(isset($_POST['btn-del']))
{
	...
	$sql = "DELETE FROM xff_wk_messages WHERE uid =  :id limit 1";
        ...
        ?>       
        <script> location.replace("../theChallenge/challenge_admin.php"); </script>
        <?php    
}
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-2">
              ...
              <h1 class="animated slideInLeft"><span>Delete a Message</span></h1>
            </div>
            <div class="col-md-8">
...
<form id="delete-messages" class="form-horizontal" method="post" >
         ...
         <tr>
            ...
            <a href="../theChallenge/challenge_admin.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>            </td>
        </tr>
