...
<title>The Weeks Homework</title>
...
<?php
    ...
    $dispweek=$getID['week'];
        ...
        // select all data
        $query = "SELECT * FROM xff_wk_messages WHERE week_code= '$week' and type='HOM'";
    ...
    <div class="wrapper">
        ...
        <div class="row">
            <div class="col-md-2">
                <!--- Content of left box goes here --->
              <div class="thumbnail float-left">
                  <img  src="/img/lgfimages/keep-calm-and-do-your-homework-252.png" alt="homework Pic">
              </div> 
            </div>
            <div class="col-md-10">
             <div Id='home'>
              <div class="table-responsive">
                  ...
                  <tr>
                  <th class="fff-color">Hi <?php echo userValue(null, "FirstName"); ?> Welcome to <?php echo " $dispweek" ?> Homework</th>
                  <th></th>               
                  </tr>
                    <?php
                  ...
                  <td style="border-top:0px" ><a href="<?php echo $row['link']; ?>"  class="btn btn-success" ><?php echo $row['link_label'] ; ?></a></td>
                  </tr>
