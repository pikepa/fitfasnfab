...
<?php
        ...
        if(isset($_POST['btn-save']))
        {
            ...
            $notes = nl2br2($_POST['notes']);
                ...
                ?>       <script> location.replace("../mysql/add_homework.php?inserted"); </script>?<?php
                }
                else
                {
                ?>       <script> location.replace("../mysql/add_homework.php?failure"); </script>?<?php
                }
        }
?>  
 </head>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">      
                ...
                ?>
<form id="add-homework" class="form-horizontal" method="post" >
