<?php
		...
		include("../php-scripts/connection.php");
 		...
 		if (!$_POST['password']) $error.="<br />Please enter your password";
			...
			$query= "SELECT * FROM `ff_users` WHERE email ='".mysqli_real_escape_string($link, $_POST['email'])."'";
			...
			$query = "INSERT INTO `ff_users` (`email`, `password`) VALUES ('".mysqli_real_escape_string($link, $_POST['email'])."', '".md5(md5($_POST['email']).$_POST['password'])."')";
	...
	if ($_POST['submit'] == "Log In") {	
		...
		$query = "SELECT * FROM ff_users WHERE email='".mysqli_real_escape_string($link, $_POST['loginemail'])."'AND 
